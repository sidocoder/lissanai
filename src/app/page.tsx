...
export default function LandingPage() {
  ...
  const features: Feature[] = [
    ...
    },
    {
      ...
      items: ["Real-time corrections", "Style improvements", "Clarity scoring"],
      gradient: "bg-[#E3FFE6]",
      text: "#0CA61E",
    },
    {
      ...
      items: ["Real-time feedback", "Real-time corrections"],
      gradient: "bg-[#FEFFD0]",
      text: "#E19120",
    },
    {
      ...
      subtitle: "Learn English basics",
      items: ["Grammar", "Vocabulary", "Tenses"],
      gradient: "bg-[#E8E6E8]",
      text: "#474447",
    },
  ];
  ...
  const steps: Step[] = [
    {
      ...
      description:
        "Create your account and take a quick assessment to tailor your learning plan.",
    },
    {
      number: "2",
      title: "Practice Daily",
      description:
        "Engage with personalized lessons, mock interviews, and writing exercises.",
    },
    {
      number: "3",
      title: "Land Your Job",
      description:
        "Apply your improved skills to real opportunities and track your progress.",
    },
  ];
      ...
      <main className="pt-16">
        ...
        <section className="relative bg-[#dbe2ef] py-20 lg:py-24 overflow-hidden">
          <div className="absolute inset-0 opacity-20">
            <svg
              className="absolute right-0 top-0 w-full h-auto md:w-[502px]"
              viewBox="0 0 502 256"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            >
              <path
                d="M502 256C502 114.613 389.387 0 248 0H0V256H502Z"
              ...
              <defs>
                ...
                >
                  <stop stopColor="#A0E7E5" stopOpacity="0" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="text-[#112d4e]">
                <h1 className="text-4xl lg:text-5xl font-extrabold mb-6 leading-tight">
                  Your Personal English Coach for Global Opportunities
                </h1>
                <p className="text-lg lg:text-xl mb-8 text-[#1f1f1f]/90 max-w-xl mx-auto lg:mx-0">
                  Master English with coaching designed specifically for
                  Ethiopians.
                </p>
                <div className="flex flex-col sm:flex-row gap-4 mb-12 justify-center lg:justify-start">
                  <button className="bg-[#337fa1] text-white px-8 py-3 rounded-xl font-semibold text-lg shadow-lg hover:bg-[#266583] transition-all transform hover:scale-105">
                    Start Practicing Free
                  </button>
                  <button className="border-2 border-[#3f72af] text-[#112d4e] px-8 py-3 rounded-xl font-semibold text-lg hover:bg-[#337fa1] hover:text-white transition-colors">
                    Learn More
                  </button>
                </div>
                <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                  <span className="bg-[#0057b7] text-white px-4 py-2 rounded-full text-sm font-semibold">
                    AI Powered
                  </span>
                  <span className="bg-[#a0e7e5] text-[#112d4e] px-4 py-2 rounded-full text-sm font-semibold">
                    24/7 Available
                  </span>
                </div>
              </div>
              <div className="relative h-64 w-64 md:h-80 md:w-80 mx-auto">
                ...
                <div className="relative h-64 w-64 md:h-80 md:w-80 mx-auto flex items-center justify-center">
                  <img
                    src="/videos/welcomingmascot.gif"
        ...
        <section id="features" className="py-20 lg:py-24 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-[#112d4e] mb-4">
                Powerful Features for Your Success
              </h2>
              <p className="text-base lg:text-lg text-gray-600 max-w-3xl mx-auto">
                Everything you need to master English communication and land
                your dream international job.
              </p>
            </div>
              ...
              {features.map((feature) => (
                ...
                >
                  <div className="flex flex-col items-center mb-6 text-center">
                    ...
                    <div>
                      <h3 className="text-xl sm:text-2xl font-bold text-[#112d4e]">
                        {feature.title}
                      </h3>
        ...
        <section
          id="how-it-works"
          className="py-20 lg:py-24 bg-gradient-to-r from-white to-[#dbe2ef]"
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
            ...
            <div className="grid md:grid-cols-3 gap-y-16 md:gap-x-8">
              {steps.map((step, index) => (
                ...
                >
                  ...
                  <h3 className="text-xl sm:text-2xl font-bold text-[#112d4e] mb-4">
                    {step.title}
                  </h3>
        ...
        <section className="py-20 lg:py-24 bg-[#3d72b3]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              Join thousands of Ethiopians who are already mastering English and
              landing international opportunities.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            <div className="md:col-span-2 lg:col-span-1">
              ...
              <p className="mb-6 pr-4">
                Empowering Ethiopians to achieve global career success through
          ...
          <div className="border-t border-gray-700 pt-8">
            <p className="text-center text-gray-400">
              © {new Date().getFullYear()} LissanAI. All rights reserved. Made
              with ❤️ by A2SVIANS
            </p>
          </div>
        </div>
